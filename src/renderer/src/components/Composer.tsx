  ...
  return (
    <div className="flex-none pt-2 pb-4">
      <div className="mx-auto w-full max-w-[800px] px-8">
        <div className="rounded-xl border border-input bg-background shadow-xs transition focus-within:border-ring focus-within:ring-[3px] focus-within:ring-ring/15">
          <textarea
            ref={taRef}
            rows={1}
            value={value}
            ...
            className="block max-h-40 w-full resize-none bg-transparent px-4 pt-3 pb-3 text-base leading-[1.6] outline-none placeholder:text-muted-foreground"
          />
